...
model_path = "ocr_model.keras"  # Replace with the path to your saved model
...
test_images = np.expand_dims(test_images, -1)  # Add channel dimension (28, 28) -> (28, 28, 1)

# One-hot encode labels
num_classes = 62  # Adjust based on EMNIST classes (e.g., digits + letters)
...
index_to_label.update({i + 36: chr(97 + i) for i in range(26)})  # Map indices 36-61 to a-z
